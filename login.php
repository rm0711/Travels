...
if (isset($_POST['submit']) && !empty($_POST['submit'])) {
    ...
    $pass = md5($_POST['pass']);
    $select = "SELECT * FROM user_form WHERE email = '$email' AND pass = '$pass'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $error[] = 'incorrect email or pa ssword!';
    }
}
...
<div class="form-container">
      ...
      <form action="" method="post">
         ...
         <p>Visit  Our Website <a href="Home.php">Hazira Vikas Travels</a></p>
      </form>
